#ifndef __SPROTODEFINES_H
#define __SPROTODEFINES_H
...
#define SPROTO_HEADER_POS_CMD 6
#define SPROTO_HEADER_POS_SRCADDR 8
#define SPROTO_HEADER_POS_DSTADDR 10
#define SPROTO_HEADER_POS_ENCRYPTION 12
#define SPROTO_HEADER_POS_CRC 13
#define SPROTO_HEADER_POS_CRCMINI 8

#define SPROTO_HEADER_LENGTH 14
#define SPROTO_HEADER_LENGTHMINI 9
#define SPROTO_LENGTH_UNKNOWN 0xffffffff

#define SPROTO_STARTBYTE '&'
#define SPROTO_STARTBYTEMINI '%'
#define SPROTO_VERSION 0x02
...
#define SPROTO_TIME_SUM_SINCEBOOT 155
